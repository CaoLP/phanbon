	...
	<div class="row">
					...
					<div class="panel-heading">Actions</div>
						<div class="panel-body">
							<ul class="nav nav-pills nav-stacked">
								<li><?php echo $this->Html->link(__('<span class="glyphicon glyphicon-plus"></span>&nbsp;&nbsp;New Role Menu'), array('action' => 'add'), array('escape' => false)); ?></li>
		...
		<div class="col-md-9">
			...
			<?php echo $this->Html->link($roleMenu['Menu']['name'], array('controller' => 'menus', 'action' => 'view', $roleMenu['Menu']['id'])); ?>
						...
						<td class="actions">
							<?php echo $this->Html->link('<span class="glyphicon glyphicon-search"></span>', array('action' => 'view', $roleMenu['RoleMenu']['id']), array('escape' => false)); ?>
							<?php echo $this->Html->link('<span class="glyphicon glyphicon-edit"></span>', array('action' => 'edit', $roleMenu['RoleMenu']['id']), array('escape' => false)); ?>
							<?php echo $this->Form->postLink('<span class="glyphicon glyphicon-remove"></span>', array('action' => 'delete', $roleMenu['RoleMenu']['id']), array('escape' => false), __('Are you sure you want to delete # %s?', $roleMenu['RoleMenu']['id'])); ?>
						</td>
					</tr>
				<?php endforeach; ?>
				</tbody>
